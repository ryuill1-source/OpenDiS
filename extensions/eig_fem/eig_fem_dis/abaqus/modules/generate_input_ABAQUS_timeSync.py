def generate_input_ABAQUS_timeSync(foldername_restart, foldername_ABAQUS, erate, Load_Stage, original_length, paradis_timeNow):
    import numpy as np
    import os
    import re
    ...
    if Load_Stage == 1:
        ...
        FEM_Du = 0.0  # Fallback for unexpected Load_Stage
